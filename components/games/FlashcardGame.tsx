    ...
    return (
      <div className="h-full bg-slate-950 flex flex-col items-center justify-center text-white p-8 text-center space-y-6 font-inter">
        ...
        <div>
            ...
            <p className="text-slate-400 mt-2 text-sm font-medium">Không tìm thấy thẻ nhớ nào phù hợp.</p>
        </div>
        <button onClick={onExit} className="px-8 py-3 bg-purple-600 text-white font-black uppercase tracking-widest rounded-xl hover:bg-purple-500 transition-all shadow-lg">
            Quay lại
        </button>
      </div>
    );
